...
DATASET_PATH=/shared/3/projects/benlitterer/podcastData/processed/floydMonth/floydMonthData.jsonl
NER_COL="transcript"
...
OUT_PATH=/shared/3/projects/benlitterer/podcastData/NER/transcripts/transcriptNEs.tsv
