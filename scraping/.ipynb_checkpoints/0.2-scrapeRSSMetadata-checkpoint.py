...
def getMP3Links(rssLink, s): 
    
    try:
        #get the xml for the rss feed   
        response = s.get(rssLink, timeout=(10, 20))
...
cols = ['Unnamed: 0', 'id', 'url', 'title', 'lastUpdate', 'link',
...
print(f"processing {len(toProcess)} rss feeds", flush=True)
