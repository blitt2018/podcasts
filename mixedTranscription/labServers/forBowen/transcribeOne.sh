...
TRANSCRIPTS_PATH=$STORAGE_DIR/transcripts/beforeFMonth
PROSODY_PATH=$STORAGE_DIR/prosody/beforeFMonth
...
GET_URL_PATH=/home/blitt/projects/podcasts/mixedTranscription/fileTracking/weekBeforeFloyd/getNextURLSetProcessing.py
UPDATE_URL_PROCESSED=/home/blitt/projects/podcasts/mixedTranscription/fileTracking/weekBeforeFloyd/updateUrlProcessed.py
MERGE_SCRIPT_PATH=/home/blitt/projects/podcasts/merging/mergeTransProsody.py 
MERGED_PATH=/shared/3/projects/benlitterer/podcastData/prosodyMerged/beforeFMonthNEW
#LOG_PATH=$STORAGE_DIR/logs/beforeFMonth
...
do 
    ...
    echo "merged to $MERGED_PATH/$HIER_PATH/${kURL}MERGED" 
